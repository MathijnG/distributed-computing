      ...
      <Container style={{ padding: '5rem', height: '100vh' }}>
        <Row style={{ height: '100%' }}>
          <Col style={{ padding: '3rem', margin: 'auto' }}>
            ...
            <p>
              The python code you submit will be distributed on a cluster of
              several workstations to improve performance.
            </p>
            {error && (
              <Alert
                dismissible
                ...
                variant="danger"
              >
                The title or code field(s) are empty! Please fill in all the
                fields to submit your code.
              </Alert>
            )}
            {success && (
              <Alert
